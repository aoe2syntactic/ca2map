...
function processFile() {
    ...
    if (file) {
        ...
        nameInput.placeholder = file.name.substr(0, file.name.lastIndexOf('.')) + '_minimap.png' 
    }
}
...
function exportImage() {
    ...
    link.href = imgUrl;
    link.download = nameInput.value ?? file.name.substr(0, file.name.lastIndexOf('.')) + '_minimap.png'
    link.click();
}
